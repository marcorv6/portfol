    ...
    <article className="space-y-12 max-w-5xl mx-auto">
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="p-4 rounded-xl bg-slate-900/60 border border-white/10 space-y-1">
          <span className="text-[11px] font-mono text-slate-400 uppercase">Latency Target</span>
          <p className="text-xl font-extrabold text-white font-mono">&lt; 100ms</p>
          <span className="text-[10px] text-slate-400 block">Neon Pooled Queries</span>
        </div>

        <div className="p-4 rounded-xl bg-slate-900/60 border border-white/10 space-y-1">
          <span className="text-[11px] font-mono text-slate-400 uppercase">Architecture</span>
          <p className="text-xl font-extrabold text-white font-mono">SSR Handlers</p>
          <span className="text-[10px] text-slate-400 block">100% Server Execution</span>
        </div>

        <div className="p-4 rounded-xl bg-slate-900/60 border border-white/10 space-y-1">
          <span className="text-[11px] font-mono text-slate-400 uppercase">Security</span>
          <p className="text-xl font-extrabold text-emerald-400 font-mono">IDOR Guarded</p>
          <span className="text-[10px] text-slate-400 block">Boundary Protection</span>
        </div>

        <div className="p-4 rounded-xl bg-slate-900/60 border border-white/10 space-y-1">
          <span className="text-[11px] font-mono text-slate-400 uppercase">Database</span>
          <p className="text-xl font-extrabold text-blue-400 font-mono">6 Tables</p>
      ...
      <section className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-white/10">
          <div>
            ...
            <p className="text-xs text-slate-400 font-light">Explore system diagrams, relational database architecture, and REST API standards.</p>
          </div>
          ...
          >
            <div className="p-6 rounded-2xl bg-slate-900/60 border border-white/10 space-y-6">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-white">Full-Stack System Data Flow</h3>
              </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-900/60 border border-white/10 space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4 font-mono text-xs">
                <div className="p-4 rounded-xl bg-slate-950 border border-white/10 space-y-1">
                  ...
                  <p className="text-slate-400 text-[11px]">Primary auth entity storing UUID, email, password_hash (bcrypt), and avatar_url.</p>
                </div>
                ...
                <div className="p-4 rounded-xl bg-slate-950 border border-white/10 space-y-1">
                  ...
                  <p className="text-slate-400 text-[11px]">Core tasks entity with priorities, due dates, and compound indexes on (user_id, completed).</p>
                </div>
            ...
            <div className="p-6 rounded-2xl bg-slate-900/60 border border-white/10 space-y-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-bold text-white">OpenAPI v3.0 REST Specification</h3>
                </div>
              ...
              <div className="rounded-xl border border-white/10 overflow-hidden font-mono text-xs">
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-white/5 text-slate-300 bg-slate-900/40">
                    ...
                    <tr>
                      <td className="p-3 text-yellow-400 font-bold">PATCH</td>
      ...
      <section className="p-6 rounded-2xl bg-gradient-to-r from-blue-900/30 via-slate-900 to-slate-950 border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="space-y-1 text-center sm:text-left">
          <h3 className="text-lg font-bold text-white">Experience TaskFlow Live</h3>
          <p className="text-xs text-slate-400 font-light">Explore the application directly or review the full source code on GitHub.</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900 border border-white/10 hover:border-white/20 text-slate-300 hover:text-white text-xs font-mono transition-all"
          >
            <Github className="w-4 h-4" />
            Source Code
          </a>
